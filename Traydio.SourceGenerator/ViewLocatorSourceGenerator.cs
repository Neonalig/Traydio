...
public sealed class ViewLocatorSourceGenerator : IIncrementalGenerator
{
        ...
        ImmutableArray<MappingCandidate?> viewModelMappings)
    {
        ...
        context.AddSource(
            ...
            BuildLocatorSource(config, mappings.Values, allowDiConstructors, emitAvaloniaTemplate, DateTime.UtcNow));
    }
        ...
        DateTime buildDateUtc)
    {
        ...
        var buildDateIso = buildDateUtc.ToString("O", global::System.Globalization.CultureInfo.InvariantCulture);
        var builder = new StringBuilder();
        builder.AppendLine("// <auto-generated/>");
        builder.AppendLine("#nullable enable");
        builder.AppendLine();
        ...
        builder.AppendLine();
        builder.Append("        public static string BuildDateUtcIso8601 => \"").Append(buildDateIso).AppendLine("\";");
        builder.AppendLine();
        builder.AppendLine("        public static global::System.DateTime BuildDateUtc => global::System.DateTime.Parse(BuildDateUtcIso8601, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.RoundtripKind);");
        builder.AppendLine();
        builder.AppendLine("        public static int BuildYear => BuildDateUtc.Year;");
        builder.AppendLine();
